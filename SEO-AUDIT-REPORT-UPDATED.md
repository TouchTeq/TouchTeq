...
| 2 | No breadcrumb navigation on service pages | Medium | High |
| 3 | Missing FAQ schema markup on service pages with FAQs | Medium | High |
...
- **Verified:** All sitemap URLs exist in the file structure
...
- ✅ FAQPage schema on homepage FAQ component
- ✅ Article JSON-LD on insight articles
- ✅ BreadcrumbJsonLd on about page and insight articles

**Missing Schema:**
- ❌ FAQPage schema on service pages with FAQs (fire-and-gas-detection has 6 FAQs)
- ❌ BlogPosting schema on insight articles (currently using Article type)
...
- FAQ schema implemented via FAQ component
...
- Breadcrumb navigation on about page and insight articles

### ⚠️ Breadcrumb Navigation — PARTIAL

**Current State:**
- ✅ About page has BreadcrumbJsonLd schema
- ✅ Insight articles have BreadcrumbJsonLd schema
- ❌ Service pages lack visual breadcrumbs and BreadcrumbList schema
- ❌ Homepage lacks breadcrumbs (acceptable)

**Recommendation:** Add BreadcrumbList schema and visual breadcrumbs to all service pages.
...
2. **Add FAQPage schema markup to service pages**
   - Implement on fire-and-gas-detection page (has 6 FAQs)
   - Add to other service pages as FAQ sections are added
...
3. **Add BreadcrumbList schema to service pages**
   - Implement on all service pages with visual breadcrumbs
...
7. **Add breadcrumbs to service pages**
...
7. **FAQ schema on homepage** — Can generate rich snippets
8. **Article schema on insights** — Proper structured data for blog content
9. **Breadcrumb schema on about and insights** — Good navigation signals
10. **Strong internal linking** — Footer, service cross-links, CTAs
11. **Mobile-responsive design** — Tailwind responsive classes throughout
12. **Professional branding** — Consistent visual identity and messaging
13. **Technical content** — Insight articles demonstrate genuine engineering knowledge
