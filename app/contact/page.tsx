...
const faqs = [
  ...
  { q: "Do you respond to formal tenders and RFQs?", a: "Yes. We regularly participate in formal procurement and tender processes for large industrial projects. We provide detailed quotations with technical proposals, project programmes, resource plans, and the required commercial and legal documentation. If you have a specific tender format or compliance checklist, send it through and we will work to your requirements." },
    ...
    <main className="bg-white min-h-screen font-sans">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: 'Contact Us', url: 'https://www.touchteq.co.za/contact' },
        ]}
      />
      <FAQJsonLd
        faqs={faqs.map((faq) => ({
