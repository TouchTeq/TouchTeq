        ...
        <div className="lg:col-span-2 flex flex-col items-center">
          <div className="flex items-center justify-between w-full mb-6">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-slate-600 hover:text-[#F26400] transition-colors"
            >
        ...
        <div className="space-y-8">
          ...
          <div className="bg-[#151B28] border border-slate-800/50 rounded-xl p-6 shadow-2xl">
            <h3 className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-6 flex items-center gap-2">
              <TrendingUp size={14} className="text-[#F26400]" /> Settlement Summary
            </h3>
          ...
          <div className="bg-[#151B28] border border-slate-800/50 rounded-xl shadow-2xl overflow-hidden">
            <div className="p-6 border-b border-slate-800/50 flex items-center justify-between">
              <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white">
                <History size={16} className="text-[#F26400]" /> Payment Trail
              </div>
              {payments.length > 0 && (
          ...
          <div className="bg-[#151B28] border border-slate-800/50 rounded-xl shadow-2xl overflow-hidden mt-8">
            <div className="p-6 border-b border-slate-800/50 flex items-center justify-between">
              <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white">
                <BellRing size={16} className="text-[#F26400]" /> Reminder Sequence
              </div>
            </div>
            ...
            <div className="p-6 space-y-8">
                ...
                {['1st Reminder', '2nd Reminder', 'Final Notice'].map((type, idx) => {
                  ...
                  return (
                    <div key={type} className="relative z-10 flex flex-col items-center gap-2">
                      <div className={`w-6 h-6 rounded-full flex items-center justify-center border-2 transition-colors ${sent ? 'bg-[#F26400] border-[#F26400] text-white shadow-[0_0_10px_rgba(249,115,22,0.4)]' : 'bg-[#0B0F19] border-slate-700 text-slate-500'
                        }`}>
              ...
              {(invoice.status === 'Overdue' || invoice.status === 'Sent') && (
                <button
                  ...
                  className="w-full py-4 bg-[#1e293b] hover:bg-[#F26400] hover:text-white text-slate-400 rounded-sm font-black text-xs uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 group"
                >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#0B0F19] border border-slate-800 rounded p-4 pl-10 text-white font-black text-xl outline-none focus:border-[#F26400]"
                    />
                  </div>
                  <p className="text-[10px] font-bold text-[#F26400] uppercase tracking-widest text-right">Max: {formatCurrency(invoice.balance_due)}</p>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-4 py-3 border rounded-lg transition-all font-bold text-sm bg-[#0B0F19] ${paymentMethodOpen ? 'border-[#F26400]' : 'border-slate-700 hover:border-slate-600'
                          }`}
                      >
                        ...
                        <div className="absolute top-full left-0 w-full mt-2 bg-[#0B0F19] border border-slate-700 rounded-lg shadow-xl z-50">
                          {['EFT', 'Cash', 'Other'].map((method) => (
                            <button
                              ...
                              className={`w-full px-4 py-2.5 text-left hover:bg-[#151B28] transition-colors font-bold text-sm uppercase tracking-widest ${paymentForm.method === method ? 'text-[#F26400]' : 'text-slate-300'
                                }`}
                            >
                              {method}
                            </button>
                ...
                <div className="bg-[#0B0F19] p-4 rounded-lg border border-slate-800">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    {recipientMatched !== 'none' && (
                      <span className="px-2 py-1 rounded bg-[#F26400]/10 text-[#F26400] text-[10px] font-black uppercase tracking-widest">
                        {recipientMatched}
                      </span>
                    )}
                  </div>
