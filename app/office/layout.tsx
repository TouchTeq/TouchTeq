...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Sales Orders', href: '/office/sales-orders', icon: ClipboardList },
      ...
      { name: 'Delivery Notes', href: '/office/delivery-notes', icon: Truck },
...
export default function OfficeLayout({ children }: { children: React.ReactNode }) {
  ...
  const paletteItems: CommandPaletteItem[] = [
    ...
    { id: 'sales-orders', label: 'Sales Orders', keywords: 'sales order confirmed customer order fulfil', Icon: ClipboardList as any, onSelect: () => router.push('/office/sales-orders') },
    { id: 'new-sales-order', label: 'New Sales Order', keywords: 'create sales order', Icon: ClipboardList as any, onSelect: () => router.push('/office/sales-orders/new') },
    ...
    { id: 'delivery-notes', label: 'Delivery Notes', keywords: 'delivery note dispatch goods sign-off proof', Icon: Truck as any, onSelect: () => router.push('/office/delivery-notes') },
