                        ...
                        {data.ageing.map(a => (
                           <tr key={a.clientId} className="hover:bg-red-500/5 transition-colors group">
                              <td className="px-6 py-5 font-black text-white">
                                 {a.clientName}
                                 {a.hasOpeningBalance && (
                                    <span className="ml-2 text-[8px] font-black uppercase px-1.5 py-0.5 bg-amber-500/10 text-amber-500 rounded">
                                       Sage
                                    </span>
                                 )}
                              </td>
                              ...
                              <td className={`px-6 py-5 text-right font-black ${a.agePlus > 0 ? 'text-red-500' : 'text-slate-600'}`}>
                                 {formatCurrency(a.agePlus)}
                                 {a.hasOpeningBalance && a.openingBalance > 0 && (
                                    <div className="text-[8px] text-amber-500/70 font-medium mt-0.5">
                                       Includes {formatCurrency(a.openingBalance)} opening
                                    </div>
                                 )}
                              </td>
